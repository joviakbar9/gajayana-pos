...
module.exports = {
  ...
  deleteProduk: async (req, res) => {
    try {
      await ItemModel.findOneAndUpdate({ _id: req.params.id}, {isArchive: true});
  ...
  deleteKategori: async (req, res) => {
    try {
      await KategoriModel.findOneAndUpdate({ _id: req.params.id}, {isArchive: true});
  ...
  deletePegawai: async (req, res) => {
    try {
      await PegawaiModel.findOneAndUpdate({ _id: req.params.id}, {isArchive: true});
